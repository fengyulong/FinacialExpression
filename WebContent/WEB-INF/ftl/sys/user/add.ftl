...
<form id="add_form" action="${path}/sys/user/add" method="post">
	...
	<table style="width:100%;padding:10px;">
		...
		<tr>
			<td>性别:</td>
			<td>
				<input class="easyui-combobox" name="sex"  value="${(user.sex)!}" data-options="valueField:'value',textField:'text',editable:false,data:[{value:'M',text:'男'},{value:'F',text:'女'}]" />
			</td>
			<td>状态:</td>
			<td>
				<input class="easyui-combobox" name="status"  value="${(user.status)!'E'}" data-options="valueField:'value',textField:'text',editable:false,data:[{value:'E',text:'正常'},{value:'D',text:'禁用'},{value:'L',text:'锁定'}]" />
			</td>
		</tr>
	</table>
</form>
